...
class TipeBengkelRepo {
  final DioClient dioClient;
  final SharedPreferences sharedPreferences;

  TipeBengkelRepo({@required this.dioClient, @required this.sharedPreferences});

  Future<ApiResponse> getTipeBengkelList() async {
    try {
      final response = await dioClient.get(
        AppConstants.TIPE_BENGKEL_URI,
        queryParameters: {
